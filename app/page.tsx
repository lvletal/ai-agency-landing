  ...
  return (
    <main className="flex flex-col min-h-screen font-sans bg-black text-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[30%] h-[50%] bg-purple-900/20 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-10%] left-[20%] w-[50%] h-[40%] bg-blue-900/10 rounded-full blur-[100px]" />
      </div>

      <div className="max-w-[1400px] mx-auto w-full">
        {/* Navigation */}
        <nav className="flex justify-between items-center px-6 py-6 backdrop-blur-md sticky top-0 z-50 border-b border-white/5">
          <div className="font-bold border-2 border-white px-3 py-1 rounded tracking-tighter shadow-lg shadow-purple-900/20 text-lg">
            AI Lite Kit.
          </div>
          <button
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-md mx-auto">
              <div className="p-8 border border-purple-500/30 bg-purple-900/10 rounded-2xl relative overflow-hidden text-center backdrop-blur-sm">
                ...
                <button
                  onClick={() => window.open('https://7407893433666.gumroad.com/l/wcinpg', '_blank')}
                  className="w-full bg-white hover:bg-gray-200 text-black px-6 py-4 rounded-xl text-lg font-bold transition">
                  Buy Now
                </button>
                <p className="text-gray-500 text-xs mt-4">
                   Refund Policy: Since this is a digital downloadable product (source code), 
                  <span className="block mt-1">all sales are final and non-refundable.</span>
                </p>
              </div>
            </div>
          </div>
